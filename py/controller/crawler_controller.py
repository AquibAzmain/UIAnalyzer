...
class CrawlerController:
    ...
    def crawl(self, link, site_name):
        ...
        if site_name in link and link not in CrawlerController.visited_links and not link.startswith('#'):
...
cloner.crawl("http://localhost/class8_1/", "http://localhost/class8_1/")
