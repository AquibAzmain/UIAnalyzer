...
def save(bs, element, check, site_name):
...
def save_assets(html_text, site):
    bs = BeautifulSoup(html_text, "html.parser")
    # save(bs=bs, element="link", check=".css")
    save(bs=bs, element="script", check=".js", site_name=site)
...
def crawl(link, site_name):
    ...
    if site_name in link and link not in visited_links and not link.startswith('#'):
...
#crawl("http://localhost/shworolipi/" + "/", "http://localhost/shworolipi/")
print("Link crawled\n")
